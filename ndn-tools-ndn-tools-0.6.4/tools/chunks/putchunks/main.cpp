...
main(int argc, char* argv[])
{
  ...
  if (opts.maxSegmentSize < 1 || opts.maxSegmentSize > ndn::MAX_NDN_PACKET_SIZE) {
    std::cerr << "ERROR: Maximum chunk size must be between 1 and " << ndn::MAX_NDN_PACKET_SIZE << std::endl;
    return 2;
  }
