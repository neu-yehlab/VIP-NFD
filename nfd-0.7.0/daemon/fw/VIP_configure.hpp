...
#define LINK_CAPACITY 0.1 //link capacity unit GB/period
#define PERIOD 5_s //psriodically send virtual packets and update VIP table
#define CS_LIMIT 0.0 //cache limit at data object/ data block level unit # of data blocks
#define SERVICE_RATE 0.0 //Rate to satisfy interest by cache unit GB/peroid
