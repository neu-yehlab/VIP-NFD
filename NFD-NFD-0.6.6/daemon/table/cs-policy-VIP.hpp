    ...
    namespace cs {
        namespace VIPcache {
            ...
            struct csVIPEntry
            {
                ...
                inline csVIPEntry(std::string objectName_,iterator it_)
                {
                    m_objectName = objectName_;
                ...
                inline csVIPEntry(std::string objectName_,double rxVIPAvg_,iterator it_)
                {
                    m_objectName=objectName_;
                    m_cacheScore=rxVIPAvg_;
                    //m_VIPCount=VIPCount_;
                ...
                std::map<std::string,iterator> m_fileLevelTable;
